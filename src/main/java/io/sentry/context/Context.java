...
/**
 * Context is used to hold context data (such as {@link Breadcrumb}s) so that
 * data may be collected in different parts of an application and then sent
 * together when an exception occurs.
 */
public class Context implements Serializable {
	 ...
	 *
	 * @param breadcrumbLimit
	 *            Number of Breadcrumb objects to retain in ring buffer.
	 */
	...
	/**
	 * Get the UUID of the last event sent by this thread, useful for handling user
	 * feedback.
	 *
	 * <b>Returns null</b> if no event has been sent by this thread or if the event
	 * has been cleared. For example the SentryServletRequestListener clears the
	 * thread's Context at the end of each request.
	 *
	...
	/**
	 * Store the UUID of the last sent event by this thread, useful for handling
	 * user feedback.
	 *
	 * @param id
	 *            UUID of the last event sent by this thread.
	 */
