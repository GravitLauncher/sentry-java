...
/**
 * An object that represents a single breadcrumb. Events may include a list of
 * breadcrumbs that help users re-create the path of actions that occurred which
 * lead to the Event happening.
 */
public class Breadcrumb implements Serializable {
	...
	public enum Level {
		 ...
		 *
		 * @param value
		 *            Value to use for serialization.
		 */
		Level(String value) {
			this.value = value;
		}
	...
	public boolean equals(Object o) {
		...
		return type == that.type && Objects.equals(timestamp, that.timestamp) && level == that.level
