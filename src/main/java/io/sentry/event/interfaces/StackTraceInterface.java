...
/**
 * The StackTrace interface for Sentry, allowing to add a stackTrace to an
 * event.
 */
public class StackTraceInterface implements SentryInterface {
	 ...
	 * Creates a StackTrace for an {@link io.sentry.event.Event}.
	 * <p>
	 * With the help of the enclosing StackTrace, figure out which frames are in
	 * common with the parent exception to potentially hide them later in Sentry.
	 *
	 * @param stackTrace
	 *            StackTrace to provide to Sentry.
	 * @param enclosingStackTrace
	 *            StackTrace of the enclosing exception, to determine how many Stack
	 *            frames are in common.
	 */
	...
	public String toString() {
		return "StackTraceInterface{" + "stackTrace=" + Arrays.toString(stackTrace) + '}';
	}
}
