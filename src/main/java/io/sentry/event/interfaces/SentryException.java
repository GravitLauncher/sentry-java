...
public final class SentryException implements Serializable {
	 ...
	 *            exception's class name (simple name).
	 * @param exceptionPackageName
	 *            exception's package name.
	 * @param stackTraceInterface
	 *            {@code StackTraceInterface} holding the StackTrace information of
	 *            the exception.
	 */
	public SentryException(String exceptionMessage, String exceptionClassName, String exceptionPackageName,
	 ...
	 * <p>
	 * The {@code childExceptionStackTrace} parameter is used to define the common
	 * frames with the child exception (Exception caused by {@code throwable}).
	 *
	 * @param throwable
	 *            Java exception to send to Sentry.
	 * @param childExceptionStackTrace
	 *            StackTrace of the exception caused by {@code throwable}.
	 */
	public SentryException(Throwable throwable, StackTraceElement[] childExceptionStackTrace) {
		exceptionMessage = throwable.getMessage();
		exceptionClassName = throwable.getClass().getSimpleName();
		Package exceptionPackage = throwable.getClass().getPackage();
		exceptionPackageName = exceptionPackage != null ? exceptionPackage.getName() : null;
		stackTraceInterface = new StackTraceInterface(throwable.getStackTrace(), childExceptionStackTrace,
	 ...
	 *
	 * @return the exception package name or {@link #DEFAULT_PACKAGE_NAME} if it
	 *         isn't defined.
	 */
	...
	public String toString() {
		return "SentryException{" + "exceptionMessage='" + exceptionMessage + '\'' + ", exceptionClassName='"
				+ exceptionClassName + '\'' + ", exceptionPackageName='" + exceptionPackageName + '\''
				+ ", stackTraceInterface=" + stackTraceInterface + '}';
	}
}
