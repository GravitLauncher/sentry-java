...
/**
 * The User interface for Sentry allows to send details about the User currently
...
public class UserInterface implements SentryInterface {
	 ...
	 *
	 * @param id
	 *            Id of the user in the system, as a String.
	 * @param username
	 *            Name of the user.
	 * @param ipAddress
	 *            IP address used to connect to the application.
	 * @param email
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(id, that.id) && Objects.equals(username, that.username)
				&& Objects.equals(ipAddress, that.ipAddress) && Objects.equals(email, that.email)
	...
	public String toString() {
		return "UserInterface{" + "id='" + id + '\'' + ", username='" + username + '\'' + ", ipAddress='" + ipAddress
