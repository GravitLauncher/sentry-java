...
/**
 * JsonGenerator that makes an attempt at serializing any Java POJO to the
 * "best" JSON representation. For example, iterables should become JSON arrays,
 * Maps should become JSON objects, etc. As a fallback we use
 * {@link Object#toString()}.
 *
 * Every method except {@link JsonGenerator#writeObject(Object)} is proxied to
 * an underlying {@link JsonGenerator}.
 */
public class SentryJsonGenerator extends JsonGenerator {
	 ...
	 *
	 * @param generator
	 *            Underlying JsonGenerator used for actual writing
	 */
	public SentryJsonGenerator(JsonGenerator generator) {
		this.generator = generator;

		maxLengthList = MAX_LENGTH_LIST;
		maxLengthString = MAX_LENGTH_STRING;
	 ...
	 *            Value to write out.
	 * @throws IOException
	 *             On Jackson error (unserializable object).
	 */
	@Override
