...
/**
 * Binding system allowing to convert an {@link HttpInterface} into a JSON
 * stream.
 */
public class HttpInterfaceBinding implements InterfaceBinding<HttpInterface> {
	 ...
	 *
	 * See
	 * <a href="https://docs.sentry.io/clientdev/data-handling/#variable-size">the
	 * SDK reference</a> for more information.
	 */
	...
	private void writeData(JsonGenerator generator, Map<String, Collection<String>> parameterMap, String body)
			throws IOException {
