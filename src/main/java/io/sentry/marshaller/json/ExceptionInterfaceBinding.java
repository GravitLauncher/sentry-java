...
/**
 * Binding system allowing to convert an {@link ExceptionInterface} to a JSON
 * stream.
 */
public class ExceptionInterfaceBinding implements InterfaceBinding<ExceptionInterface> {
	 ...
	 * <p>
	 * Exceptions may contain StackTraces, this means that the system should also be
	 * able to send a {@link StackTraceInterface} on the JSON stream.
	 *
	 * @param stackTraceInterfaceBinding
	 *            InterfaceBinding allowing to send a {@link StackTraceInterface} on
	 *            the JSON stream.
	 */
	 ...
	 * @param generator
	 *            JSonGenerator.
	 * @param sentryException
	 *            Sentry exception with its associated {@link StackTraceInterface}.
	 * @throws IOException
	 */
