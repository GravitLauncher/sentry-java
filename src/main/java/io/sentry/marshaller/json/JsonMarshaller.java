...
public class JsonMarshaller implements Marshaller {
	...
	/**
	 * Create instance of JsonMarshaller with provided maximum length of the
	 * messages.
	 *
	...
	/**
	 * Add an interface binding to send a type of {@link SentryInterface} through a
	 * JSON stream.
	 *
	 * @param sentryInterfaceClass
	 *            Actual type of SentryInterface supported by the
	 *            {@link InterfaceBinding}
	 * @param binding
	 *            InterfaceBinding converting SentryInterfaces of type
	 *            {@code sentryInterfaceClass}.
	 * @param <T>
	 *            Type of SentryInterface received by the InterfaceBinding.
	 * @param <F>
	 *            Type of the interface stored in the event to send to the
	 *            InterfaceBinding.
	 */
	public <T extends SentryInterface, F extends T> void addInterfaceBinding(Class<F> sentryInterfaceClass,
		...
		interfaceBindings.put(sentryInterfaceClass, binding);
	}

	/**
	 * Creates the {@link JsonGenerator} used to marshall to json. This method makes
	 * it easier to provide a custom implementation.
	 *
	 * @param destination
	 *            used to read the content
	 * @return a new instance
	 * @throws IOException
	 *             on error reading the stream
	 */
	...
	/**
	 * Formats a log level into one of the accepted string representation of a log
	 * level.
	 *
	 * @param level
	 *            log level to format.
	...
	private String formatLevel(Event.Level level) {
		...
		default:
			logger.finest(
					String.format("The level '{}' isn't supported, this should NEVER happen, contact Sentry developers",
							level.name()));
			return null;
		}
	}
