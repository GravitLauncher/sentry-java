...
public class RandomEventSampler implements EventSampler {
	 ...
	 *
	 * @param sampleRate
	 *            ratio of events to allow through to the server (from 0.0 to 1.0).
	 */
	 ...
	 *            ratio of events to allow through to the server (from 0.0 to 1.0).
	 * @param random
	 *            Random instance to use for sampling, useful for testing.
	 */
	 ...
	 *
	 * @param event
	 *            Event to be checked against the sampling logic.
