...
public class Dsn {
	...
	/**
	 * Looks for a DSN configuration within JNDI, the System environment or Java
	 * properties.
	 *
	...
	public static String dsnLookup() {
		...
		if (Util.isNullOrEmpty(dsn)) {
			logger.info("*** Couldn't find a suitable DSN, Sentry operations will do nothing!"
	 ...
	 *
	 * @param dsn
	 *            DSN in a string form.
	 * @throws InvalidDsnException
	 *             the given DSN is not valid.
	 */
	...
	/**
	 * Extracts the hostname and port of the Sentry server from the DSN provided as
	 * an {@code URI}.
	 *
	 * @param dsnUri
	 *            DSN as an URI.
	...
	/**
	 * Extracts the scheme and additional protocol options from the DSN provided as
	 * an {@code URI}.
	 *
	 * @param dsnUri
	 *            DSN as an URI.
	 ...
	 * <p>
	 * Mandatory elements are the {@link #host}, {@link #publicKey} and
	 * {@link #projectId}.
	 */
	private void validate() {
		...
		if (protocol != null && !protocol.equalsIgnoreCase("noop") && !protocol.equalsIgnoreCase("out")) {
