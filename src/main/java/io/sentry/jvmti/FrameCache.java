...
public final class FrameCache {
	...
	/**
	 * Store the per-frame local variable information for the last exception thrown
	 * on this thread.
	 *
	 * @param throwable
	 *            Throwable that the provided {@link Frame}s represent.
	 * @param frames
	 *            Array of {@link Frame}s to store
	 */
	 ...
	 *
	 * When an exception is thrown it must contain at least one frame that
	 * originates from a package in this set, otherwise local variable information
	 * will not be cached. See
	 * {@link FrameCache#shouldCacheThrowable(Throwable, int)}.
	 *
	 * @param newAppPackage
	 *            package prefix to add to the set
	 */
	...
	/**
	 * Retrieve the per-frame local variable information for the last exception
	 * thrown on this thread.
	 *
	 * @param throwable
	 *            Throwable to look up cached {@link Frame}s for.
	...
	/**
	 * Check whether the provided {@link Throwable} should be cached or not. Called
	 * by the native agent code so that the Java side (this code) can check the
	 * existing cache and user configuration, such as which packages are "in app".
	 *
	 * @param throwable
	 *            Throwable to be checked
	 * @param numFrames
	 *            Number of frames in the Throwable's stacktrace
	...
	public static boolean shouldCacheThrowable(Throwable throwable, int numFrames) {
		...
		// stacktraces, which means later ("smaller") throws would overwrite the
		// existing
